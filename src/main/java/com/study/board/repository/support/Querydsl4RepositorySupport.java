package com.study.board.repository.support;
 ...
 */
@Repository
public abstract class Querydsl4RepositorySupport<D> {
    ...
    public Querydsl4RepositorySupport(Class<D> domainClass) {
    ...
    public void setEntityManager(EntityManager entityManager) {
        ...
        JpaEntityInformation<D, ?> entityInformation = JpaEntityInformationSupport.getEntityInformation(domainClass, entityManager);
        SimpleEntityPathResolver resolver = SimpleEntityPathResolver.INSTANCE;
        EntityPath<D> path = resolver.createPath(entityInformation.getJavaType());
